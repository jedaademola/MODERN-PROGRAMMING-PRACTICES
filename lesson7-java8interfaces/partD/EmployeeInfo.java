...
public class EmployeeInfo {
	...
	public static void main(String[] args) {	
		...
		/*
		   visited was initialised to false for the computation of hasCode and comparison in the equals() method,
		   the value was set to true if a duplicate occurs for the first check,sequence checks failed because visited is default as false
		 */
