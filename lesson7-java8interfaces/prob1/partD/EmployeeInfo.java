package edu.mum.mpp.lesson7.prob1.partD;
...
public class EmployeeInfo {
	...
	public static void main(String[] args) {	
		...
		/*
		   visited was initialised to false for the computation of hasCode and evaluation of equals() method,
		   the value was set to true if a duplicate occurs for the first check,
		   sequence checks failed because visited is default as false in List<Employee> list 
		   while the HashMap tracker has visited set to true hence difference objects are compared
		 */
